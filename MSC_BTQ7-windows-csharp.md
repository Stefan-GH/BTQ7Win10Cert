...
-   Replace `<replace>` with the connection string for your device (see [Provision your device and get its credentials][lnk-manage-iot-hub] **Use the Device Explorer tool to provision a device** item 5.)
